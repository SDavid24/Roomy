...
class AddInterestFragment : OnboardBaseFragment() {
    ...
    private fun configureTextFonts(){
        ...
        addInterestBinding.tvInterests.typeface = initializeDMSansTypeFace(requireActivity())
        addInterestBinding.letEveryone.typeface = initializeDMSansTypeFace(requireActivity())
        addInterestBinding.tvContinue.typeface = initializeDMSansTypeFace(requireActivity())
        itemInterestChipBinding.root.typeface = initializeDMSansTypeFace(requireActivity())
    }
